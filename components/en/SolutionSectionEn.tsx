        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-semibold text-white mb-6">
              Smart AI-powered outsourcing: faster and more accurate
            </h2>
            <p className="text-lg text-white/70 mb-6 leading-relaxed font-light">
              At Onebrain, we combine human expertise with AI to map, select,
              and engage professionals with the exact profile your company needs.
            </p>
            <p className="text-lg text-white/70 mb-8 leading-relaxed font-light">
              AI analyzes competencies, background, and cultural fit, while our hunting team
              leads an agile and highly accurate recruitment process.
            </p>
